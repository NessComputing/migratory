...
public interface MigratoryContext
{
    MigratoryDBI getDBI();

    MigratoryDBI getRootDBI();

    MigratoryConfig getConfig();

    DbSupport getDbSupport();

    LoaderManager getLoaderManager();

    Collection<MigrationLocator> getLocators();

    MigrationInformationStrategy getInformationStrategy();
}
